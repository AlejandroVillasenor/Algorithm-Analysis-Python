        ...
        while(len(vectorOfVisited)!=nodosEnUno):
            ...
            for movement in movements:
                ...
                if newPosition[0]<0 or newPosition[1]<0 or newPosition[1]>=mapaCols or newPosition[0]>=mapaRows:
                    ...
                    #Buscamos si ya esta en la lista de etiquetados
                    encontrado=False
                    for labeled in vectorOfLabeled:
                        if (labeled==adjacentNode):
                            ...
                            if (labeled.cost>adjacentNode.cost):
                                ...
                                cost[newPosition[0]][newPosition[1]]=adjacentNode.cost
            ...
            #Ordenamos la lista de etiquetados
            vectorOfLabeled.sort(key=lambda x: x.cost, reverse=False)
        #Obtenemos el camino de reversa
        for visitedNode in vectorOfVisited:
            if visitedNode==endNode:
                endNode=visitedNode
                break
        #Una vez encontrado el que se marca como final, se recorre el grafo hacia atras siguiendo los padres
...
goal= [30,24]
#tamaño para el espacio o segmento para incluir el boton
topPadding=50
#creo el objeto para el algortimo Dijsktra
search=Dijkstra()
